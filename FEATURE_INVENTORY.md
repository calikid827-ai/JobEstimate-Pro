...
- Actionable Scope Decisions V1 appears in the former Quick Clarifications position inside Review Before Sending and does not add a sixth Command Center section or another diagnostics panel. It renders zero to three contractor-facing decisions from safely structured Smart Question metadata. Current runtime actionability is limited to structured material responsibility; trusted quantity or explicit scope-boundary metadata is accepted only with allowlisted subjects and, for quantity, a matching fixed basis/unit. Generic warning, diagnostic, plan, photo, Scope X-Ray, PriceGuard, missed-scope, or AI prose cannot manufacture a deterministic subject or sentence. Ceilings, doors/frames, closets, repairs, access equipment, protection, furniture moving, occupied-area coordination, and generic quantity remain deferred without explicit trustworthy metadata.
