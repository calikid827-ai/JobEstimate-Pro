...
1. Polish or audit the next optional intelligence layer around typed scope as the required scope-control anchor: Smart Questions V2 pricing-authority audit only, company intelligence / saved-estimate learning, camera measuring prototype, voice-to-scope draft, plan-to-scope reconciliation, or mobile/browser visual QA for the polished Smart Questions panel. Keep Evidence Authority internal/debug-only unless normal API/saved/UI/PDF exposure is separately scoped.
