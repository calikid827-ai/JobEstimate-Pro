...
- Next active smart-upgrade direction: Actuals vs Estimate Feedback V1. Keep variance feedback reference-only; it must not automatically update Rate Card defaults, pricing formulas, pricing authority, or labor totals.
- Follow with Photo Intelligence Actions V1, Plan Intelligence Workflow V1, and Contractor Learning System as separately scoped phases. Plan/photo findings remain review-only and non-pricing-authoritative unless a later explicit estimator-confirmation workflow establishes stronger authority.
...
1. Build Actuals vs Estimate Feedback V1 as reference-only variance feedback that cannot automatically change Rate Card or pricing.
