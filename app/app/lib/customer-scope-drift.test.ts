...
test("does not warn for drywall substrate context in painting output", () => {
  const contextOnlyPhrases = [
    ...
    "Customer-facing scope includes two coats over existing standard drywall surfaces.",
    ...
    "Customer-facing scope includes light sanding and patching of minor imperfections to facilitate proper paint adhesion.",
    ...
    "Customer-facing scope includes light sanding and dust removal on standard drywall surfaces to facilitate proper paint adhesion.",
    ...
    "Customer-facing scope includes primer and finish coats appropriate for interior drywall.",
    "Customer-facing scope includes interior latex paint appropriate for drywall surfaces.",
    "Customer-facing scope assumes the existing drywall is free of significant defects requiring repair.",
    "Customer-facing scope presumes existing drywall in satisfactory condition.",
    "Customer-facing scope presumes the existing drywall is in sound condition, with no requirement for patching or repair.",
    "Customer-facing scope will be coordinated with concurrent drywall or renovation activities to minimize disruption.",
    ...
    "Customer-facing scope includes painting walls targeting existing standard drywall surfaces.",
    "Customer-facing scope includes primer and finish paint for full coverage of the drywall surfaces.",
    ...
    "This Change Order / Estimate encompasses the preparation and application of two coats of paint on the walls of three bedrooms, targeting existing standard drywall surfaces. The scope entails surface preparation, including light sanding and dust removal, to facilitate proper paint adhesion. Materials will consist of primer and finish paint to achieve uniform coverage of the drywall surfaces.",
    "This Estimate encompasses the proposed painting of walls in three bedrooms, involving the application of two coats over existing standard drywall surfaces. The scope includes surface preparation, which entails light sanding and patching of minor imperfections to facilitate proper paint adhesion. Prior to painting, all furniture and flooring in the bedrooms will be safeguarded with drop cloths and masking materials. The work will be organized to minimize disruption, with coordination efforts to prevent conflicts with other trades. Paint materials will consist of primer and finish coats appropriate for interior drywall. Upon completion of the two coats, the work area will be cleared of all debris, masking materials will be removed, and surfaces will be left in a condition ready for occupancy. This scope excludes ceilings, trim, or doors, and presumes normal access and existing drywall in satisfactory condition.",
    "This Change Order / Estimate encompasses the preparation and application of two coats of paint on the walls of three existing bedrooms. The scope entails surface preparation, including light sanding and cleaning of the standard drywall surfaces to facilitate proper paint adhesion. All adjacent finishes and flooring will be safeguarded using masking and drop cloths to prevent overspray or damage. The work will be sequenced to allow adequate drying time between coats and will be coordinated with any concurrent drywall or renovation activities to minimize disruption. Materials provided include interior latex paint appropriate for drywall surfaces, primer, masking tape, and consumables such as rollers, brushes, and drop cloths. Upon completion of the painting, the area will be cleared of all debris, masking will be removed, and surfaces will be inspected for uniform coverage. This scope presumes the existing drywall is in sound condition, with no requirement for patching or repair. Mobilization and site setup are included to accommodate the small-scale nature of the work.",
  ]
...
test("does not warn for painting masking context around outlets and switches", () => {
  const contextOnlyPhrases = [
    ...
    "Customer-facing scope includes painting walls. Coordination with the electrical trade is necessary to safely remove and reinstall outlet covers without affecting wiring or devices.",
    "Customer-facing scope includes painting walls. Coordination with electrical trade necessary to safely remove/reinstall outlet covers without affecting wiring or devices.",
    "Customer-facing scope includes painting walls. Electrical trade coordination necessary to safely remove and reinstall outlet covers without affecting wiring or devices.",
    "Customer-facing scope includes painting walls. Safely remove and reinstall outlet covers without affecting wiring or devices.",
    "Customer-facing scope includes painting walls. Outlet covers safely removed and reinstalled without affecting wiring or devices.",
    "Customer-facing scope includes painting walls. Outlet covers removed/reinstalled without affecting wiring or devices.",
    ...
    "Customer-facing scope includes painting walls. Electrical outlet covers will be removed and reinstalled for painting only.",
    ...
    "Customer-facing scope includes painting walls. Coordination with the electrical trade is strictly limited to the removal and reinstallation of outlet covers.",
    ...
    "Customer-facing scope includes painting walls. Work will be coordinated to avoid interference with existing wiring and devices during removal/reinstallation of outlet covers.",
    "Customer-facing scope includes painting walls. No electrical repairs or modifications beyond handling outlet covers.",
    "Customer-facing scope includes painting walls. No modifications to the electrical system.",
    ...
    "Customer-facing scope includes painting walls. The scope entails the removal and careful storage of all outlet covers prior to the commencement of painting.",
    "Customer-facing scope includes painting walls. Upon completion of painting, all outlet covers will be reinstalled.",
    "Customer-facing scope includes painting walls. Two complete coats of interior wall paint will be applied after the outlet covers are removed.",
    "Customer-facing scope includes painting walls. The scope entails the meticulous removal and subsequent reinstallation of all outlet covers to facilitate uninterrupted wall painting.",
    "Customer-facing scope includes painting walls. Coordination with the electrical trade is necessary to safely remove and reinstall outlet covers without affecting wiring or devices.",
    "Customer-facing scope includes painting walls. Coordination with the electrical trade is necessary to safely remove and reinstall outlet covers without causing damage to wiring or devices.",
    "Customer-facing scope includes painting walls. Work refreshes wall surfaces without modifying electrical components beyond the handling of outlet covers.",
    ...
    "This Change Order / Estimate encompasses the preparation and painting of walls in three existing bedrooms. The scope involves the removal and careful storage of all outlet covers in these rooms prior to painting. Work will be coordinated to avoid interference with existing wiring and devices during removal/reinstallation. This scope includes no electrical repairs or modifications beyond handling outlet covers.",
    "This Change Order / Estimate encompasses the preparation and painting of walls in three existing bedrooms. The scope entails the removal and careful storage of all electrical outlet covers in these rooms prior to commencing painting activities. Surface preparation will involve cleaning and light sanding to enhance paint adhesion on the existing wall finishes. Two complete coats of interior wall paint will be applied, with appropriate drying time allowed between each coat. Following the painting process, outlet covers will be reinstalled in their original positions. The work includes masking and protecting adjacent surfaces and flooring to prevent any paint overspray or damage. Coordination with the electrical trade is strictly limited to the removal and reinstallation of outlet covers, with no modifications to the electrical system. Cleanup will consist of the removal of all masking materials and the disposal of paint-related waste, ensuring the rooms are ready for client use. This estimate is based on the scope described above.",
  ]
...
test("does not warn for flooring fitment baseboard context", () => {
  const contextOnlyPhrases = [
    ...
    "Customer-facing scope includes flooring installation with thresholds, transitions, cutting, fitting, and securing flooring at adjacent surfaces.",
    "Customer-facing scope includes flooring installation threshold fitment, cutting, fitting, trimming, and securing flooring at transitions.",
...
test("true carpentry and trim work still warns when unsupported", () => {
  const trueCarpentryPhrases = [
    ...
    "Customer-facing scope includes trim carpentry is included.",
    "Customer-facing scope includes install thresholds as carpentry.",
    "Customer-facing scope includes replace thresholds as carpentry.",
  ]
