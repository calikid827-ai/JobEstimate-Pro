...
const ELECTRICAL_COVER_PLATE_PAINTING_CONTEXT_PATTERN =
  /\b(remov(?:e|ed|al)?(?:\s*\/\s*|\s+and\s+)?reinstall(?:ed|ation|ing)?)\b.{0,100}\b(outlet\s+covers?|switch\s+covers?|cover\s+plates?)\b.{0,100}\b(paint|painting|painted)\b|\b(outlet\s+covers?|switch\s+covers?|cover\s+plates?)\b.{0,100}\b(remov(?:e|ed|al)?(?:\s*\/\s*|\s+and\s+)?reinstall(?:ed|ation|ing)?)\b.{0,100}\b(paint|painting|painted)\b/i
