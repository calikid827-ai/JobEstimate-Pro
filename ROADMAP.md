...
2. Next active product-improvement task: continue real-PDF QA and estimator UI clarity review for plan evidence, selected-page readback, and customer-output safety.
