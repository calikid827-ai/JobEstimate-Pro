...
2. Next active product-improvement task: cross-trade backend scope-boundary regression review.
...
- NEXT AUDIT: Run a cross-trade backend scope-boundary regression review for by-others, owner-supplied, protection, coordination, and existing-condition language before expanding this pattern beyond the Case 7A fix.
