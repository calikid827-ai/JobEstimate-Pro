...
2. Next active product-improvement task: Phase 6 backend route diagnostics / Estimate Defense raw scope parsing audit.
...
- NEXT: Phase 6 backend route diagnostics / Estimate Defense raw scope parsing audit. Audit backend diagnostics next because the UI-side review stack now consumes EstimatorScopeFacts, while route-level trade-stack, complexity, schedule, materials, Scope-to-Price X-Ray, Estimate Defense, and diagnostics may still parse raw scope independently.
