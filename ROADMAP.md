...
- NEXT: Optional intelligence-layer upgrades should keep typed scope as the scope-control anchor. Good next candidates are voice-to-scope draft, company intelligence / saved-estimate learning audit, camera measuring prototype audit, or plan-to-scope reconciliation. Do not make photo, plan, camera, voice, or learned signals pricing-authoritative unless a later task explicitly scopes that authority and verification path.
