...
4. NEXT PRODUCT-INTELLIGENCE FEATURE: Photo Intelligence Actions V1. Keep photo actions inside Review Before Sending, preserve five Command Center sections, reuse the Scope Decisions interaction pattern instead of retaining a parallel Smart Scope Assist action flow, bind actionability to the generated evidence snapshot, and suppress stale actions after photo changes. Photos remain non-pricing-authoritative; any estimating effect must come through explicit contractor action that changes typed scope followed by successful regeneration.
...
- DONE: Actuals vs Estimate Feedback V1 is reference-only and complete. The bounded Whole-Product Intelligence & Simplification Review and its focused Canonical Contractor Status Semantics Cleanup (`2c8ebb1`) are also complete. Photo Intelligence Actions V1 is now the next product-intelligence feature, followed by Plan Intelligence Workflow V1 and Contractor Learning System as separately scoped phases.
