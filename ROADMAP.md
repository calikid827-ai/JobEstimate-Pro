...
5. Follow with Contractor Learning System after the reference-only feedback and evidence workflows are stable.
6. Continue using `PRODUCT_AUDIT_BACKLOG.md` as the master improvement tracker and work each phase as a focused change. Typed scope remains the required scope-control anchor, and plan/photo/crew/Smart Question signals remain non-pricing-authoritative unless a later task explicitly scopes authority and verification.
7. Keep final Production Live Mode subscription verification using `SUBSCRIPTION_TEST_CHECKLIST.md` pending as the final pre-launch gate before accepting public paid users.
...
- NEXT: Actuals vs Estimate Feedback V1 should provide reference-only estimate-versus-actual feedback without automatically changing Rate Card, pricing formulas, pricing authority, or labor totals. Photo Intelligence Actions V1, Plan Intelligence Workflow V1, and Contractor Learning System follow as separately scoped phases.
