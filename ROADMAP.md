...
2. Next active product-improvement task: Phase 3 Customer Scope Drift migration to EstimatorScopeFacts.
...
- NEXT: Phase 3 EstimatorScopeFacts migration for Customer Scope Drift. Migrate unsupported customer-scope warning logic next because it has the richest boundary-context rules and is central to preserving contractor-safe customer-facing proposals without rewriting detailed `result.text`.
