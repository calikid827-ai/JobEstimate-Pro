...
2. Next active product-improvement task: EstimatorScopeFacts / shared scope-understanding audit for the estimator brain.
...
- NEXT AUDIT: EstimatorScopeFacts / shared scope-understanding audit. Map the repeated included-work vs boundary-context rules now used by Customer Scope Drift, Scope-to-Price, schedule sequencing, materials, Estimate Defense, and backend split-scope logic before implementing any shared architecture.
