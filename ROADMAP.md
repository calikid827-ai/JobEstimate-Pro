...
2. Next active product-improvement task: Phase 2 Scope-to-Price Consistency Review migration to EstimatorScopeFacts.
...
- NEXT: Phase 2 EstimatorScopeFacts migration for Scope-to-Price Consistency Review. Migrate the warning-only consistency guard first so pricing-anchor, materials, estimate-section, and mixed-scope review share the new included-work / boundary-context facts layer before broader consumers move.
