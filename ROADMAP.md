...
2. Next active product-improvement task: Phase 5 PriceGuard Review aggregator migration/audit to EstimatorScopeFacts.
...
- NEXT: Phase 5 EstimatorScopeFacts migration/audit for PriceGuard Review as the UI-side aggregator. Audit and migrate the aggregator next because it combines Customer Scope Drift, Scope-to-Price Consistency Review, Schedule Sequencing Review, scope-quality checks, materials/customer-readiness notes, and contractor risk notes before backend route diagnostics are touched.
