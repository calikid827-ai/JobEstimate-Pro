...
2. Next active product-improvement task: Phase 9B should audit or implement the safest Evidence Authority readback/display wiring without changing pricing, prompts, `result.text`, route/API shape, or customer-facing output semantics unless explicitly scoped.
