...
2. Next active product-improvement task: broader launch-readiness / regression audit before adding more estimator behavior changes. Phase 8D scope-boundary text/diagnostic cleanup is substantially complete.
...
- NEXT: Phase 8D scope-boundary text/diagnostic cleanup is substantially complete. Run a broader launch-readiness / regression audit before adding more estimator behavior changes. Deferred photo behavior items remain pricing/policy-adjacent: polluted multi-trade signals can still affect confidence penalty and measurement-heavy behavior, and raw owner-supplied / by-others quantity parsing remains unchanged.
