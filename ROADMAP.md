...
2. Next active product-improvement task: Phase 4 Schedule Sequencing Review migration to EstimatorScopeFacts.
...
- NEXT: Phase 4 EstimatorScopeFacts migration for Schedule Sequencing Review. Migrate sequencing guidance next because it still evaluates patch/texture timing, cure time, rough-in sequencing, owner-supplied material timing, and true mixed sequencing from scope text.
