...
2. Next active product-improvement task: backend split-scope / scope-to-price diagnostic noise audit from real-world QA.
...
- NEXT AUDIT: Case 7A still exposes backend split-scope / scope-to-price diagnostic noise: General Renovation primary trade, `flooring_only_v1` anchor, adjacent split scopes from excluded/protection words, and flooring materials in a painting-style scope. Audit this next without changing pricing semantics.
