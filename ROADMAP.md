...
2. Next active product-improvement task: Phase 7 missedScopeDetector / backend missed-scope diagnostics raw scope parsing audit.
...
- NEXT: Phase 7 missedScopeDetector / backend missed-scope diagnostics raw scope parsing audit. Audit this next because `missedScopeDetector` still has local raw scope/job-type parsing and feeds Scope-to-Price X-Ray risk flags and confirmation items.
