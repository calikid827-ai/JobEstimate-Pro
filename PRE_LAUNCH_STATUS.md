...
- NEXT: Work from `PRODUCT_AUDIT_BACKLOG.md`. The next highest-priority product intelligence items are unsupported trade drift detection beyond electrical, assumptions/exclusions visibility before PDF/approval actions, and Plan Review Summary raw-text noise reduction.
