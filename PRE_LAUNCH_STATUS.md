...
- NEXT: Work from `PRODUCT_AUDIT_BACKLOG.md`. The next active smart-estimator task is Phase 8D follow-up audit of photo-estimate decision text / photo pricing behavior. Do not change photo pricing behavior, `pricingAllowed`, blockers, confidence, pricing policy, prompts, `effectiveScopeChange`, `result.text`, or route/API shape without a scoped review; keep Production Live Mode subscription verification as the final pre-launch gate.
...
- NEXT: Work from `PRODUCT_AUDIT_BACKLOG.md`. The next active smart-estimator task is Phase 8D follow-up audit of photo-estimate decision text / photo pricing behavior, not billing. Keep Production Live Mode subscription verification as the final pre-launch gate.
...
- NEXT: Work from `PRODUCT_AUDIT_BACKLOG.md`. Prioritize the Phase 8D follow-up audit of photo-estimate decision text / photo pricing behavior as the next smart-estimator task. Keep final Production Live Mode subscription verification pending before public paid launch.
