...
- NEXT: Work from `PRODUCT_AUDIT_BACKLOG.md`. The next active smart-estimator task is Phase 2: migrate Scope-to-Price Consistency Review to EstimatorScopeFacts. Keep Production Live Mode subscription verification as the final pre-launch gate.
...
- NEXT: Work from `PRODUCT_AUDIT_BACKLOG.md`. The next active smart-estimator task is Phase 2: migrate Scope-to-Price Consistency Review to EstimatorScopeFacts, not billing. Keep Production Live Mode subscription verification as the final pre-launch gate.
...
- NEXT: Work from `PRODUCT_AUDIT_BACKLOG.md`. Prioritize Phase 2 Scope-to-Price Consistency Review migration to EstimatorScopeFacts as the next smart-estimator task. Keep final Production Live Mode subscription verification pending before public paid launch.
