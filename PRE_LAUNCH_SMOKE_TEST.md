...
- Print mode hides Send Readiness, Scope Decisions, Proposal delivery controls, Rate Card, Job Templates, Active Job Summary workflow-only controls, Field Handoff action controls, and Advanced Diagnostics.
